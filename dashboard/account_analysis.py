...
def render_account_analysis(df: pd.DataFrame) -> None:
    ...
    # ------------------ SAAS FILTERS BLOCK ------------------
    st.markdown('<div class="saas-card" style="padding: 20px; margin-bottom: 24px;">', unsafe_allow_html=True)
    ...
    if selected_company_name:
        ...
        # Tab 1: Overview
        with tab_overview:
            st.markdown('<div class="saas-card" style="border-top:none; border-radius:0 0 12px 12px;">', unsafe_allow_html=True)
        ...
        # Tab 6: Summary
        with tab_summary:
            st.markdown('<div class="saas-card" style="border-top:none; border-radius:0 0 12px 12px; min-height: 200px;">', unsafe_allow_html=True)
            st.markdown(f'<div style="font-size:1.02rem; line-height:1.6; color:#D1D5DB;">{company_row["account_summary"]}</div>', unsafe_allow_html=True)
            st.markdown('</div>', unsafe_allow_html=True)
